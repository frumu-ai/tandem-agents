...
from src.aca.api.auth import assert_api_token_configured, get_token
from src.aca.mcp.app import router as aca_mcp_router
...
from src.aca.core.coordination.coordination_reaper import coordination_reaper_interval, coordination_reaper_tick
from src.aca.core.execution.runtime_entrypoints import run_coordinator
from src.aca.core.scheduling.scheduler import plan_task_admissions, scheduler_snapshot
from src.aca.core.scheduling.scheduler_dispatcher import dispatch_scheduled_runs
from src.aca.core.scheduling.coder_supervisor import (
    list_active_coder_runs,
    reconcile_active_coder_runs,
    reconcile_coder_run,
)
from src.aca.core.execution.runner_core import run_qa
from src.aca.core.engine.engine import engine_status_report, resolve_repository
from src.aca.runtime.operator_dashboard import render_operator_dashboard
from src.aca.runtime.operator_view import build_operator_summary
from src.aca.runtime.workspace_registry import (
...
from src.aca.runtime.runstate import load_status, load_blackboard, set_event_broadcast_callback, new_run_id
...
async def _attach_run_manager_loop():
    ...
    # in strict mode. See src/aca/api/auth.py:assert_api_token_configured.
...
async def get_project_tasks(slug: str, token: str = Depends(get_token)):
    ...
    from src.aca.runtime.task_sources import preview_task
    try:
...
async def get_project_board(slug: str, refresh: bool = False, token: str = Depends(get_token)):
    root = Path(os.environ.get("ACA_ROOT", "."))
    _, cfg = _project_config(root, slug)
    from src.aca.runtime.task_sources import github_project_board_snapshot
