...
from src.aca.core.repository.board import card_to_task, default_board, ensure_board_template, task_to_card
...
from src.aca.core.engine.engine import execute_engine_tool, refresh_mcp_server
from src.aca.core.task_contract import (
    apply_task_contract,
...
def _task_from_kanban_board(
    ...
    *,
    ...
    from src.aca.core.repository.board import select_card
