...
from src.aca.runtime.workspace_registry import load_workspace
...
class SchedulerDispatcherTest(unittest.TestCase):
    ...
    def test_dispatcher_launches_multiple_admitted_runs_in_parallel(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("src.aca.core.scheduling.scheduler_dispatcher.run_worker", side_effect=fake_run_worker):
