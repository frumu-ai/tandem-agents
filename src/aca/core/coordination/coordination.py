...
from src.aca.utils.utils import now_ms, short_id, slugify
from src.aca.core.coordination.schema import apply_sqlite_schema, apply_postgres_schema
from src.aca.core.coordination.rows import (
    row_to_task,
    row_to_run,
    row_to_worker,
    row_to_lease,
...
def _connect_postgres(dsn: str) -> Any:
    try:
        ...
        raise RuntimeError(
            ...
            "Install ACA with Postgres support to use storage.profile=shared."
        ) from exc
