...
from src.aca.core.coordination.coordination_reaper import coordination_reaper_tick
...
class CoordinationStoreTest(unittest.TestCase):
    ...
    def test_reaper_tick_runs_for_postgres_backend(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("src.aca.core.coordination.coordination_reaper.CoordinationStore.from_config", return_value=store):
                expired = coordination_reaper_tick(cfg)
    ...
    def test_postgres_backend_uses_postgres_connection_and_schema(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("src.aca.core.coordination.coordination._connect_postgres", return_value=FakeConnection()) as connect_mock:
                store = CoordinationStore.from_config(cfg)
