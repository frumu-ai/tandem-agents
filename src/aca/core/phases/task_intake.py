...
def run_task_intake(
    ...
    from src.aca.core.integrations.github_mcp import github_mcp_scope, github_remote_sync_mode
    from src.aca.core.engine.coder_backend import coder_backend_mode
    from src.aca.core.repository.board import card_to_task, claim_card, save_board, select_card
    from src.aca.core.execution.run_lifecycle import block_run
    from src.aca.core.execution import runner_core as _rc
    from src.aca.runtime.runstate import append_event, initial_blackboard, initial_status, save_blackboard
    from src.aca.runtime.run_output import (
        set_status,
        write_blackboard_snapshot,
        write_board_snapshot,
    )
    from src.aca.runtime.task_sources import normalize_task
    from src.aca.core.task_contract import task_contract_completeness
    from src.aca.core.execution.run_lifecycle import build_provider_config_dict, build_swarm_config_dict
