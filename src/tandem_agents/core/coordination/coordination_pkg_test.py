...
class SchemaTest(unittest.TestCase):
    ...
    def test_sqlite_schema_contains_required_tables(self) -> None:
        from src.tandem_agents.core.coordination.schema import SQLITE_SCHEMA
    ...
    def test_postgres_schema_contains_required_tables(self) -> None:
        from src.tandem_agents.core.coordination.schema import POSTGRES_SCHEMA
    ...
    def test_apply_sqlite_schema_creates_tables(self) -> None:
        from src.tandem_agents.core.coordination.schema import apply_sqlite_schema
...
class RowHelpersTest(unittest.TestCase):
    ...
    def test_row_to_task_none(self) -> None:
        from src.tandem_agents.core.coordination.rows import row_to_task

        self.assertEqual(row_to_task(None), {})

    def test_row_to_run_none(self) -> None:
        from src.tandem_agents.core.coordination.rows import row_to_run

        self.assertEqual(row_to_run(None), {})

    def test_row_to_worker_none(self) -> None:
        from src.tandem_agents.core.coordination.rows import row_to_worker

        self.assertEqual(row_to_worker(None), {})

    def test_row_to_lease_none(self) -> None:
        from src.tandem_agents.core.coordination.rows import row_to_lease

        self.assertEqual(row_to_lease(None), {})

    def test_row_to_outbox_none(self) -> None:
        from src.tandem_agents.core.coordination.rows import row_to_outbox

        self.assertEqual(row_to_outbox(None), {})

    def test_row_to_scheduler_event_none(self) -> None:
        from src.tandem_agents.core.coordination.rows import row_to_scheduler_event
