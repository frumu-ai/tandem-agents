...
from src.tandem_agents.mcp.app import create_app
    ...
    def test_describe_aca_requires_token_and_reports_runtime_snapshot(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch.dict("os.environ", env, clear=False):
                with patch("src.tandem_agents.mcp.snapshot.engine_status_report") as engine_mock:
                    ...
                    with patch("src.tandem_agents.mcp.snapshot.get_mcp_server") as server_mock:
                        server_mock.return_value = {
                            "enabled": True,
                            "connected": True,
                            "transport": "https://api.githubcopilot.com/mcp/",
                        }
                        with patch("src.tandem_agents.mcp.snapshot.latest_run_dir") as latest_run_mock:
